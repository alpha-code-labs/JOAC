...
public class FBXProcessor_Fielder : EditorWindow
{
    private string relativeFolderPath = "Assets/Cutscene FBX Fielder"; // CHANGE THIS

    [MenuItem("Tools/Process Fielder FBX Animations")]
    public static void ShowWindow()
    {
        GetWindow<FBXProcessor_Fielder>("FBX Animation Processor");
    }
    ...
    {
        string centralPrefabFolder = "Assets/Resources/Sequences/Fielder";
